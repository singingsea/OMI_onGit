function merge_Pandora_and_OMI_rotation_test()
...
save_fig = 1;
if use_ECCC_no2
    %output_path = ['C:\Projects\OMI\plots\Wind_transport\' site '\' Pandora_no '\' method '_eccc\'];
    output_path = ['C:\Projects\OMI\plots\Wind_transport\' Pandora_no '\' method '_eccc\'];
else
    %output_path = ['C:\Projects\OMI\plots\Wind_transport\' site '\' Pandora_no '\' method '_knmi\'];
    output_path = ['C:\Projects\OMI\plots\Wind_transport\' Pandora_no '\' method '_knmi\'];
end
...
if strcmp(Pandora_no,'104')
    Pandora_data = ['C:\Projects\Pandora\output\' Pandora_no '\Pandora' Pandora_no '_' site '_2015_2018_DSNO2.mat'];% this is combined 2015 to 2018 data for Pandora 104
elseif strcmp(Pandora_no,'122104')
    Pandora_data = ['C:\Projects\Pandora\output\FortMckay\Pandora_DS_NO2_FortMcKay.mat'];
end
...
TropOMI_data = ['C:\Projects\OMI\from_Chris\transport\' site '\OMI_transport.mat'];
...
load(Pandora_data);
load(TropOMI_data);TropOMI=OMI_transport;
DU = 2.6870e+16;
