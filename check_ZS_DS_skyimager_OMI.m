...
%load('C:\Projects\Zenith_NO2\matlab_ZSDS_skyimager_OMI_DS_corrected2.mat');%
%this was the corrected DS using Vitali's method, but OMI data was not
%properly sorted! 
%load('C:\Projects\Zenith_NO2\matlab_ZSDS_skyimager_OMI_closest_DS_corrected');
load('C:\Projects\Zenith_NO2\matlab_ZSDS_skyimager_OMI_f2_DS_corrected');
...
TF1 = strcmp(data.mean_type,"dis_f2");
